...
- [Usage](#usage)
  ...
  - [Converting JavaScript to TypeScript](#convert-to-typescript)
  - [Refactoring Code](#refactor-code)
  - [Generating Unit Tests](#generate-unit-tests)
  - [Displaying Help](#display-help)
  - [Displaying the Version](#display-version)
- [Examples](#examples)
